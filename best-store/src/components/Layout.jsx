...
export function Navbar (){
    return(
        <nav className="navbar navbar-expand-lg bg-white  text-center border-bottom boxshadow">
  <div className="container">
       <Link className="navbar-brand" to="/">
         <img src="../image.png"/>Best Store
        </Link>
...
export function Footer(){
  return(
     ...
     <div className=" text-center p-4 border-top">
       <img src="./" alt="..." srcset="" width="30" className="me-2" />
       Best Store 
     </div>
